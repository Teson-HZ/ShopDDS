...
@WebServlet("/SelectAssignServlet")
...
//        String username = (String) session.getAttribute("");
        ...
        List<Assign> CommodityAllList = new ArrayList<>();
...
//                    String dateString = sdf.format(date);
                ...
                // 调试：打印assign_Amount字段的值
               int assignAmount = rs.getInt("assign_Amount");
                    Assign commodity = new Assign(
            ...
            // 转发请求到JSP页面
            req.getRequestDispatcher("Show_Assign.jsp").forward(req, resp);

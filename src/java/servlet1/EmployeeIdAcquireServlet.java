...
@WebServlet("/EmployeeIdAcquireServlet")
public class EmployeeIdAcquireServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for (Employee manager : managers) {
            ...
            jsonObject.put("name", manager.getEmployee_Name());
            jsonObject.put("ide", manager.getEmployee_Ide());
    ...
    private List<Employee> getWarehouseManagersFromDatabase() {
        ...
        try {
            ...
            String sql = "SELECT employee_Id,employee_Name,employee_Ide FROM employee";
            ...
            while (rs.next()) {
                ...
                employee.setEmployee_Ide(rs.getString("employee_Ide"));

...
@WebServlet("/SelectSuperServlet")
public class SelectSuperServlet extends HttpServlet {
    @Override
...
//        String username = (String) session.getAttribute("");
        ...
        List<Supermarket> CommodityAllList = new ArrayList<>();
...
//                    String dateString = sdf.format(date);
                // Admin类有一个构造函数，用于从结果集初始化数据
                    Supermarket commodity = new Supermarket(
                    rs.getString("supermarket_Id"),
                    rs.getString("supermarket_Name"),
                    rs.getString("supermarket_Adr"),
                    rs.getString("supermarket_Tel"),
            ...
            // 转发请求到JSP页面
            req.getRequestDispatcher("Show_Supermarket.jsp").forward(req, resp);

...
//        String username = (String) session.getAttribute("");
        ...
        List<Employee> CommodityAllList = new ArrayList<>();
...
//                    String dateString = sdf.format(date);
                // Admin类有一个构造函数，用于从结果集初始化数据
                    Employee commodity = new Employee(
                    rs.getString("employee_Id"),
                    rs.getString("employee_Name"),
                    rs.getString("employee_Pwd"),
                    rs.getString("employee_Ide"),
            ...
            // 转发请求到JSP页面
            req.getRequestDispatcher("Show_Employee.jsp").forward(req, resp);

...
@WebServlet("/SelectAcceptServlet")
public class SelectAcceptServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String getSupermarketIdSQL = "SELECT supermarket_Id FROM supermarket WHERE employee_Id=?";
            ...
            if (supermarketId == null) {
                throw new SQLException("Supermarket ID not found for employee: " + username);
            }
            
            String sql = "SELECT warehouse_Id,commodity_Id,allocate_Amount FROM allocate where supermarket_Id=?";
            ...
            // 转发请求到JSP页面
            req.getRequestDispatcher("Show_superAllocate.jsp").forward(req, resp);
